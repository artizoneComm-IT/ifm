...
if(!empty($_POST['names']) AND !empty($_POST['last_names']) AND !empty($_POST['pseudo']) AND !empty($_POST['birthday']) AND !empty($_POST['phone1']) AND !empty($_POST['addresses']) AND !empty($_POST['email']) AND !empty($_POST['passwords']) AND !empty($_POST['id_categorie']))
{
